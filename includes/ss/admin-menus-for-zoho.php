...
class AdminMenusForZoho {
	...
	public function createAdminPage() {
		...
		<tr>
			...
			<td>
				<input type="text" name="zoho_client_id" id="zoho_client_id" value="<?php echo $dataSet->getInfo( 'zoho_client_id' ); ?>">
				<p class="guid">
		...
		<tr>
			...
			<td>
				<input type="password" name="zoho_client_secret" id="zoho_client_secret" value="<?php echo $dataSet->getInfo( 'zoho_client_secret' ); ?>">
				<p class="guid">
		...
		<tr>
			<td><h4>Zoho User EmailD</h4></td>
			<td>
				<input type="text" name="zoho_user_email" id="zoho_user_email" value="<?php echo $dataSet->getInfo( 'zoho_user_email' ); ?>">
			</td>
		</tr>
		<?php
